...
STRINGS = {
    "en": {
        ...
        "started": "NeuralScreen is running · F11 for menu",
        "hotkeys": "F10 NR · F11 menu · Insert record · Ctrl+Alt+Q quit",
        "title": "NeuralScreen",
    ...
    "ru": {
        ...
        "started": "NeuralScreen работает · F11 — меню",
        "hotkeys": "F10 NR · F11 меню · Insert запись · Ctrl+Alt+Q выход",
        "title": "NeuralScreen",
