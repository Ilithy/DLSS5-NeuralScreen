...
оверлеем, прозрачным для кликов. Только RTX 50-серии.
...
> **v1.0.0.** Весь конвейер на GPU — захват, нейронный проход и вывод внутри
> воркера; Python считает только guides оптического потока (0.1–0.2 мс/кадр).
> RTX 5070 Ti, рабочий стол 4K, work 1920×1080: **55 FPS с NR, 121–133 FPS в
> bypass**.
