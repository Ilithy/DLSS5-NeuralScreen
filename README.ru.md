...
- **Обрабатывать в пониженном разрешении** — примерно **на 50% больше кадров**
  ценой чуть более мягкой картинки. По умолчанию выключено. Включите,
  посмотрите на свой экран и решите сами; ползунок под ним задаёт, насколько
  сильно.
...
**Картинка мягкая.** Выключите в меню «Обрабатывать в пониженном разрешении».
