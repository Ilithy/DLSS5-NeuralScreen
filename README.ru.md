...
релиза — это файл NVIDIA, и он на её условиях. Это pre-release/internal
сборка (310.8.0), утёкшая в моддерскую экосистему; распространяется как
есть, без изменений и без гарантий NVIDIA. Подпись Authenticode не
совпадает (файл перепакован) — относитесь к нему как к research-only ПО.
