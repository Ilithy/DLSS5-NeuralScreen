...
> рабочий стол 1440p, work 1280×720: **64 FPS с NR, 64+ FPS в режиме NR off
> (bypass)**.
...
Замерено на RTX 5070 Ti, рабочий стол 1440p, `work_scale` 0.5 (1280×720),
...
Собственно **NGX — около 1 мс**. Остальное — конвейер. На реальном движении
растёт стоимость guides (DISOpticalFlow на 320×180 ≈ 1.4 мс + растяжение), но
остаётся малой на фоне `recv`.
