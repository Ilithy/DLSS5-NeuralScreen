...
(Faithful / Natural / Strong / Extreme), четыре параметра NR, язык (ru/en),
светлая/тёмная тема, «открывать меню при запуске» и кнопки Скриншот /
Справка / Запись / Выход / Закрыть.
