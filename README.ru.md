...
Программа живёт в трее и рисует поверх рабочего стола. **F11** — меню.

| Клавиша | Что делает |
|---|---|
| **F11** | открыть / закрыть меню |
| **F10** | нейронная обработка вкл / выкл |
| **Home** | скриншот |
...
папке `recordings`. **Home** сохраняет скриншот. Если меню открыто, оно попадёт
